...
// BuscarPorID trás um usuário pelo seu ID
...
// Atualizar atualiza um usuário pelo seu ID
...
// Deletar deleta um usuário pelo seu ID
...
// BuscarSeguindo retorna os usuários que um usuário segue
