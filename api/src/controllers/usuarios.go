...
// SeguirUsuario permite que um usuario siga outro usuário
...
// PararDeSeguirUsuario permite que um usuario pare de seguir outro usuário
...
// BuscarSeguidores permite que um usuário busque os seguidores de outro usuário
...
// BuscarSeguindo permite que um usuário busque quem outro usuário está seguindo
...
// AtualizarSenha permite que um usuário atualize sua senha
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificarSenha(senha.Atual, senhaNoBanco); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha atual não confere"))
		return
	}
